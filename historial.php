...
<?php
    ...
    <?php
		...
		$result = mysqli_query($link, "SELECT nombre_p, correo, precio, cupo FROM usuarios as u, productos as p, historial as h WHERE h.id_producto_compra=p.id_producto AND h.id_usuario_compra = u.id_usuario;");
