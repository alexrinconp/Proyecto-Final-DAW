...
<?php
    ...
    <?php
        ...
        $name_t = mysqli_real_escape_string($link, $_POST['curso']);
        $desc_t = mysqli_real_escape_string($link, $_POST['desc']);
        $photo = mysqli_real_escape_string($link, $_POST['foto']);
        $price = mysqli_real_escape_string($link, $_POST['precio']);
        $cap = mysqli_real_escape_string($link, $_POST['cupo']);
        $name_i = mysqli_real_escape_string($link, $_POST['tutor']);
        $univ = mysqli_real_escape_string($link, $_POST['uni']);
        $sch = mysqli_real_escape_string($link, $_POST['hor']);
        $mat = mysqli_real_escape_string($link, $_POST['mat']);

        $sql="INSERT INTO productos (nombre_p, desc_p, foto, precio, cupo, instructor, universidad, horario, materia) VALUES ('$name_t', '$desc_t', '$photo',
		'$price','$cap','$name_i', '$univ', '$sch', '$mat');";
    ...
    <?php
		...
		$result = mysqli_query($link, "SELECT * FROM productos WHERE id_producto=(SELECT MAX(id_producto) FROM productos);");
