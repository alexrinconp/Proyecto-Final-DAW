...
<body>
    ...
    <div class="container"><h3 style="text-align: center">Algunas de nuestras tutorías más exitosas</h3><br></div>
    <div class="container">
        <div class="row">
        <?php
            $user = 'root';
            ...
            $tutorias = mysqli_query($link,"SELECT * FROM productos;");
    ...
    <div class="container">  
        <h3 style="text-align: center">Pensamos en tí</h3><br>
        <img src="https://www.ipp.edu.pe/blog/wp-content/uploads/2020/05/shutterstock_1489158410.jpg" alt="Me" class="w3-image" style="display:block;margin:auto" width="800" height="533">
        <div>
        <h4 style="text-align: center"><b>El estudiante promedio</b></h4>
        <h5 style="text-align: center"><i>¿Cansado de estudiar sin parar? ¿Harto de llegar a exámenes donde solo sabes tu nombre?</i></h6>
        <p style="text-align: center">Contamos con cursos y tutorias para todos los niveles en los cuales puedes aclarar todas tus dudas, adelantarte en materias o prepararte para cualquier reto que te presente la carrera</p>
        </div>
    </div>
