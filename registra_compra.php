...
<?php
    ...
    <?php
        ...
        $fecha = date("Y/m/d");
          ...
          $sql3 = mysqli_query($link, "DELETE FROM carrito WHERE id_usuario = '$id_usuario' AND id_producto = '$id_producto';");
          mysqli_close($link);

	?>
    </div><br>
    <div class="container">
        <h2>Felicidades, recibirás por correo una liga para reunirte con tu tutor<h2>
    </div>
