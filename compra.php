...
<?php
    ...
    <?php
		...
		if (mysqli_connect_errno()) {
          ...
          $id_temporal = mysqli_real_escape_string($link, $_POST['id_usuario']);
          $result = mysqli_query($link, "SELECT c.id_producto, nombre_p, precio, cupo, instructor, universidad, horario FROM usuarios as u, productos as p, carrito as c WHERE c.id_producto=p.id_producto AND c.id_usuario = u.id_usuario AND c.id_usuario = $id_temporal;");
            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                echo "<td>";
                echo "<form action='registra_compra.php' method='post'>";
                echo "<input type = 'int' style='display:none;' name = 'id_usuario' id = 'id_usuario' value=\"".$id_usuario."\"/>";
                echo "<input type = 'int' style='display:none;' name = 'correo' id = 'correo' value=\"".$correo."\"/>";
                echo "<input type = 'int' style='display:none;' name = 'id_producto' id = 'id_producto' value=\"".$row['id_producto']."\"/>";
