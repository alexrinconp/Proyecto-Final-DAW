...
<?php
    ...
    <?php
		...
		if (mysqli_connect_errno()) {
          ...
          $id_tutoria = mysqli_real_escape_string($link, $_POST['id_tutoria']);
		  $result = mysqli_query($link,"SELECT * FROM productos WHERE id_producto = '$id_tutoria';");
		  ...
		  $id_tutoria = $row[0];
                ...
                if ($cupo>=1){
                    ...
                    echo "<span style='text-align: center'><h2>" . $row[1] . "</h2></span>";
                    echo "<span style='text-align: center'><h3>" . $row[2] . "</h3></span>";
                    echo "<span style='text-align: center'><h4>Instructor = " . $row[6] . "</h4></span>";
                    echo "<span style='text-align: center'><h4>Universidad = " . $row[7] . "</h4></span>";
                    echo "<span style='text-align: center'><h4>Horario = " . $row[8] . "</h4></span>";
